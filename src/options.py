...
class Options():
    ...
    def init(self, parser): 
        ...
        parser.add_argument('--data_path', '-dp', type=str, help='Training data path',
                            default='/dataset_sub/soiling_dataset_new/')
        ...
        ### Train settings
        parser.add_argument('--model_type', type=str, help='resnet_unet, Uformer16, resnet_unet_act_drop, hardnet, resnet_unet_act_no_bn, resnet_unet_dua  ', default='hardnet')
